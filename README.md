...
- **Phase 4 — vault contract + signer + audit:** **contract + signer drafted 2026-05-21.**
  - [`contracts/TreasuryVault.sol`](contracts/src/TreasuryVault.sol) — Ownable2Step + Pausable + ReentrancyGuard, single executor with target allowlist, owner-funded treasury model. Foundry tests cover all paths.
  ...
  - Not deployed. Wiring harness + exiter to the signer, deploying to Base Sepolia, and booking the external audit still ahead.
