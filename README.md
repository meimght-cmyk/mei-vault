...
- **Phase 4 — vault contract + signer + audit:** **contract drafted 2026-05-21.** [`contracts/TreasuryVault.sol`](contracts/src/TreasuryVault.sol) — Ownable2Step + Pausable + ReentrancyGuard, single executor with target allowlist, owner-funded treasury model. Foundry tests cover all paths ([test/TreasuryVault.t.sol](contracts/test/TreasuryVault.t.sol)). Not deployed. Bounded-delegation signer + external audit still ahead.
